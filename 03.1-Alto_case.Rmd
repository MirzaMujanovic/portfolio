...
Let us make a visualisation of the table:
...
We could see that Twitter is the most balanced publisher, as the sentiment scores are constant in the time observed. Some good news were published on May 27 after 18 PM as the sentiment scores for Twitter, Facebook and O2 UK in this period were extremely positive. Instagram doesn't seem to be a channel for the company. 
GiffGaff and Facebook seem to be very similar in terms of sentiment scores. They depict very similar patterns, which could mean that user behavior on these two channel is similar. 
