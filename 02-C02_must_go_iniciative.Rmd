...
```{r,error=FALSE, message=FALSE, warning=FALSE,echo=FALSE,out.width="90%",fig.align='center'}
...
```{r, error=FALSE, message=FALSE, warning=FALSE, fig.show="hide"}
# Text preparation
...
```{r, error=FALSE, message=FALSE, warning=FALSE, fig.show='hide',results='hide'}
library(wordcloud) 
library(reshape2)
par(mar = rep(0, 4))
set.seed(1234)
...
Knowing the nature of the carbon footprint related topics and based on the previous assumption about vivid discussions on Twitter, an analysis of emotions in Tweets would help us in opinion mining.
