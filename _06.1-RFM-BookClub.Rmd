...
In our case, out of 4000 rows (Customers), we will randomly assign 2800 to train data set, and the rest to test data.
...
```{r}
(gain_data<-prediction[,c("RFM_score","Florence","Predicted_RR")] %>%
